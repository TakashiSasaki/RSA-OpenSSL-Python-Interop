# Script Name: python_encrypt_rsautl_decrypt.py
...
def decrypt_message_with_rsautl():
    print("Decrypting message using 'rsautl' subcommand with PKCS#1 v1.5 padding...")
...
def main():
    print("Starting RSA encryption with Python and decryption with rsautl...")
    ...
    decrypted_message = decrypt_message_with_rsautl()
