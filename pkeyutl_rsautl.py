...
def encrypt_message(message):
    print("Encrypting message using 'pkeyutl' subcommand...")
...
def decrypt_message():
    print("Decrypting message using 'rsautl' subcommand...")
...
def main():
    print("Starting RSA encryption and decryption process using pkeyutl and rsautl...")
